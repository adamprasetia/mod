	...
	<div class="box box-default">
		<div class="box-body">
			<?php echo form_open($action,array('class'=>'form-inline'))?>
				...
				<div class="form-group">
					<?php echo form_dropdown('user',$this->master_model->dropdown('user','User'),$this->input->get('user'),'class="form-control input-sm" onchange="submit()"')?>
				</div>
				<div class="form-group">
					<?php echo form_dropdown('shift',$this->master_model->dropdown('shift','Shift'),$this->input->get('shift'),'class="form-control input-sm" onchange="submit()"')?>
				</div>
			<?php echo form_close()?>
