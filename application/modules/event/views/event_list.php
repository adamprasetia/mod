	...
	<div class="box box-default">
		<div class="box-body">
			<?php echo form_open($action,array('class'=>'form-inline'))?>
				...
				<div class="form-group">
					<?php echo form_dropdown('tipe',$this->master_model->dropdown('event_tipe','Tipe'),$this->input->get('tipe'),'class="form-control input-sm" onchange="submit()"')?>
				</div>
				<div class="form-group">
					<?php echo form_dropdown('status',$this->master_model->dropdown('event_status','Status'),$this->input->get('status'),'class="form-control input-sm" onchange="submit()"')?>
				</div>
			<?php echo form_close()?>
